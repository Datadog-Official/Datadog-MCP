...
server.tool(
  "health-check",
  "Verify Datadog MCP server configuration and connectivity. Returns system information and configuration status.",
  {
    organizationName: z.string().optional().describe("Optional: Specify your Datadog organization name")
  },
  async (args) => {
